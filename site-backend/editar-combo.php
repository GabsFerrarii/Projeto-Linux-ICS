...
<head>
  ...
  <title>Scooby Burg Backend - Combos</title>
...
<body>
  ...
  <main>
    <section class="pb-12">
      <h2 class="font-[Knewave] text-black text-4xl my-12">EDITAR COMBO</h2>
      <div class="m-0-auto bg-[#17BDB9]">
        <form action="editar-h.php" method="post" class="flex flex-col items-start p-8 m-auto h-auto"> 
            ...
            <input class="mx-auto" type="submit" value="SALVAR ALTERAÇÕES" />
        </form>
      </div>
    </section>
  </main>
